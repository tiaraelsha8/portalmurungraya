...
<head>
    ...
    <meta name="description" content="Situs resmi Pemerintah Kabupaten Murung Raya. Temukan informasi layanan publik, berita daerah, dan profil pemerintahan.">
        ...
        <div class="row g-4 mt-2">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-2 position-relative" data-aos="fade-up">
                ...
                <div x-data="{ rotate: false, showTooltip: false }" class="w-full sm:w-1/2 lg:w-1/3 xl:w-1/6 p-2 relative">
                    <!-- Avatar Card -->
                    <div @mouseenter="showTooltip = true" @mouseleave="showTooltip = false" @click="rotate = true;" :class="{ 'animate-flip': rotate }" @animationend="rotate = false"
                        class="bg-white rounded-full bg-opacity-50 shadow-lg w-[150px] h-[150px] flex items-center justify-center mx-auto transition-transform duration-300 hover:scale-105 cursor-pointer">
                        <a href="https://jdih.murungrayakab.go.id/" target="_blank"><img
                                src="asset/produkhukum.png" alt="Avatar"
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
                <div x-data="{ rotate: false, showTooltip: false }" class="w-full sm:w-1/2 lg:w-1/3 xl:w-1/6 p-2" data-aos="fade-up">
                    <div @mouseenter="showTooltip = true" @mouseleave="showTooltip = false" @click="rotate = true; openModal1()" :class="{ 'animate-flip': rotate }"
                        @animationend="rotate = false"
                        class="cursor-pointer bg-white bg-opacity-50 rounded-full shadow-lg w-[150px] h-[150px] flex items-center justify-center mx-auto hover:scale-105 transition-transform duration-300">
            ...
            <div id="popupCardModal1"
                ...
                <div
                    ...
                    <div class="flex flex-col gap-2">
                        <a href="http://dpmptsp.web.murungrayakab.go.id/" class="btn btn-primary" target="_blank">LAYANAN PERIZINAN</a>
                        <a href="https://disdukcapil.web.murungrayakab.go.id/" class="btn btn-primary" target="_blank">LAYANAN KEPENDUDUKAN</a>
                        <a href="https://dinkes.murungrayakab.go.id/2024/07/puskesmas-puruk-cahu.html" class="btn btn-primary" target="_blank">LAYANAN PUSKESMAS</a>
                        <a href="https://rsud.murungrayakab.go.id/" class="btn btn-primary" target="_blank">RSUD PURUK CAHU</a>
                        <a href="https://play.google.com/store/apps/details?id=mam.reader.imurungraya&hl=en" class="btn btn-primary" target="_blank">IMURUNG RAYA</a>
                        <a href="https://layanan.murungrayakab.go.id/lpse.murungrayakab.go.id" class="btn btn-primary" target="_blank">LPSE</a>
                        <a href="https://layanan.murungrayakab.go.id/smarttax.murungrayakab.go.id" class="btn btn-primary" target="_blank">SMARTTAX</a>
                        <a href="https://infopublik.id/mediacenter/2614" class="btn btn-primary" target="_blank">INFO PUBLIK</a>
                        ...
                        <a href="http://jdih-dprd.murungrayakab.go.id/" class="btn btn-primary" target="_blank">JDIH DPRD</a>
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
                <div x-data="{ rotate: false, showTooltip: false }" class="w-full sm:w-1/2 lg:w-1/3 xl:w-1/6 p-2" data-aos="fade-up">
                    <div @mouseenter="showTooltip = true" @mouseleave="showTooltip = false" @click="rotate = true; openModal3()" :class="{ 'animate-flip': rotate }"
                        @animationend="rotate = false"
                        class="cursor-pointer bg-white bg-opacity-50 rounded-full shadow-lg w-[150px] h-[150px] flex items-center justify-center mx-auto hover:scale-105 transition-transform duration-300">
            ...
            <div id="popupCardModal3"
                ...
                <div
                    ...
                    <h4 class="text-lg font-semibold text-center mb-4 text-gray-800">LAYANAN ADMINISTRASI PEMERINTAH</h4>

                    <div class="flex flex-col gap-2">
                        <a href="https://multidomain.mail.go.id/mail/" class="btn btn-primary" target="_blank">EMAIL PEMERINTAH DAERAH</a>
                        <a href="https://srikandi.arsip.go.id/auth/login" class="btn btn-primary" target="_blank">SRIKANDI</a>
                        <a href="http://helpdesk.murungrayakab.go.id/" class="btn btn-primary" target="_blank">PUSAT BANTUAN</a>
                        <a href="http://simpan.murungrayakab.go.id/" class="btn btn-primary" target="_blank">MANAJEMEN PENGETAHUAN</a>
                        <a href="https://kinerja.bkn.go.id/login" class="btn btn-primary" target="_blank">eKINERJA BKN</a>
                ...
                <div x-data="{ rotate: false, showTooltip: false }" class="w-full sm:w-1/2 lg:w-1/3 xl:w-1/6 p-2 relative">
                    ...
                    <div @mouseenter="showTooltip = true" @mouseleave="showTooltip = false" @click="rotate = true;" :class="{ 'animate-flip': rotate }" @animationend="rotate = false"
                        ...
                        <a href="https://www.lapor.go.id/" target="_blank"><img
                                src="asset/lapor.png" alt="Avatar"
                                class="rounded-full bg-white w-[120px] h-[120px] object-cover border-4 border-black" /></a>
                        <div x-show="showTooltip" x-transition
                            class="absolute top-full mb-2 left-1/2 transform -translate-x-1/2 bg-gray-700 text-white text-xs rounded py-1 px-2 whitespace-nowrap z-50 shadow">
                            LAPOR!
                    ...
                    <div x-show="open" x-transition:enter="" x-transition:enter-start="" x-transition:enter-end=""
                        ...
                        <div class="space-y-2">
                            <a href="http://ppid.murungrayakab.go.id/" target="_blank"
                                class="block w-full text-center bg-blue-600 text-white py-2 rounded hover:bg-blue-700 text-sm no-underline" style="text-decoration: none;">
                                PPID</a>
                            <a href="https://murakab.bps.go.id/publication.html?Publikasi%5BtahunJudul%5D=&Publikasi%5BkataKunci%5D=Murung+Raya+Dalam+Angka&Publikasi%5BcekJudul%5D=0&yt0=Tampilkan" target="_blank"
                                class="block w-full text-center bg-blue-600 text-white py-2 rounded hover:bg-blue-700 text-sm no-underline" style="text-decoration: none;">
        ...
        <div class="row g-4 mt-2">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-2 position-relative" data-aos="fade-up">
                ...
                <div x-data="{ rotate: false, showTooltip: false }" class="w-full sm:w-1/2 lg:w-1/3 xl:w-1/6 p-2 relative">
                    ...
                    <div @mouseenter="showTooltip = true" @mouseleave="showTooltip = false" @click="rotate = true;" :class="{ 'animate-flip': rotate }" @animationend="rotate = false"
                        class="bg-white rounded-full bg-opacity-50 shadow-lg w-[150px] h-[150px] flex items-center justify-center mx-auto transition-transform duration-300 hover:scale-105 cursor-pointer">
                        <a href="https://berita.murungrayakab.go.id/" target="_blank"><img
                                src="asset/berita.png" alt="Avatar"
                                class="rounded-full bg-white w-[120px] h-[120px] object-cover border-4 border-black" /></a>
                        <div x-show="showTooltip" x-transition
                            class="absolute top-full mb-2 left-1/2 transform -translate-x-1/2 bg-gray-700 text-white text-xs rounded py-1 px-2 whitespace-nowrap z-50 shadow">
                            BERITA
            ...
            <div id="popupCardModal2"
                ...
                <div
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <a href="https://inspektorat.murungrayakab.go.id/" class="btn btn-primary" target="_blank">INSPEKTORAT</a>
                        ...
                        <a href="https://diskominfo.murungrayakab.go.id/" class="btn btn-primary" target="_blank">DISKOMINFO SP</a>
                        ...
                        <a href="https://disdukcapil.murungrayakab.go.id/" class="btn btn-primary" target="_blank">DISDUKCAPIL</a>
                        <a href="https://rsud.murungrayakab.go.id/" class="btn btn-primary" target="_blank">RSUD PURUK CAHU</a>
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-2 position-relative" data-aos="fade-up">
                ...
                <div x-data="{ rotate: false, showTooltip: false }" class="w-full sm:w-1/2 lg:w-1/3 xl:w-1/6 p-2 relative">
                    ...
                    <div @mouseenter="showTooltip = true" @mouseleave="showTooltip = false" @click="rotate = true;" :class="{ 'animate-flip': rotate }" @animationend="rotate = false"
                        class="bg-white rounded-full bg-opacity-50 shadow-lg w-[150px] h-[150px] flex items-center justify-center mx-auto transition-transform duration-300 hover:scale-105 cursor-pointer">
                        <a href="https://radioswaramurungraya.com/" target="_blank"><img
                                src="asset/smurafm.png" alt="Avatar"
                                class="rounded-full bg-white w-[120px] h-[120px] object-cover border-4 border-black" /></a>
                        <div x-show="showTooltip" x-transition
                            class="absolute top-full mb-2 left-1/2 transform -translate-x-1/2 bg-gray-700 text-white text-xs rounded py-1 px-2 whitespace-nowrap z-50 shadow">
                            RADIO MURA
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-2 position-relative mx-auto">
                ...
                <div x-data="{
                    ...
                    <div @mouseenter="showTooltip = true" @mouseleave="showTooltip = false" @click="open = !open"
                        class="bg-white rounded-full bg-opacity-50 shadow-lg w-[150px] h-[150px] flex items-center justify-center mx-auto transition-transform duration-300 hover:scale-105 cursor-pointer">
                        <a href="#"><img src="asset/sosmed.png" alt="Avatar"
                                class="rounded-full bg-white w-[120px] h-[120px] object-cover border-4 border-black"/></a>
                        <div x-show="showTooltip" x-transition
                            class="absolute top-full mb-2 left-1/2 transform -translate-x-1/2 bg-gray-700 text-white text-xs rounded py-1 px-2 whitespace-nowrap z-50 shadow">
                            SOSIAL MEDIA
